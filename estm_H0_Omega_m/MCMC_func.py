...
def lpost(data_dl, delta_dl, H0_prop, Omega_m_prop, param1_low_range = 1, param1_high_range = 100, 
          param2_low_range = 0, param2_high_range = 10.0, **kwargs):
    """
    ...
    """
    if np.isinf(lprior_uniform(H0_prop, param1_low_range, param1_high_range)) or np.isinf(lprior_uniform(Omega_m_prop, param2_low_range, param2_high_range)):
        return -np.inf
    else:
        return llike(data_dl, delta_dl, H0_prop, Omega_m_prop, **kwargs)
...
def MCMC_run(data_dl, delta_dl, param_start,  printerval = 5000, H0_var_prop = 0.05, 
             Omega_m_var_prop = 0.01, Ntotal = 3000000, burnin = 0, **kwargs):
    """
